...
<section id="work" className="section max-container">    
      ...
      <ul className="categories">
        <li><button className="category category--selected">All<span className="category__count">8</span></button></li>
        <li><button className="category">Front-end<span className="category__count">4</span></button></li>
        <li><button className="category">Back-end<span className="category__count">2</span></button></li>
        <li><button className="category">Mobile<span className="category__count">2</span></button></li>
      </ul>
